...
(function () {
  ...
  async function assessState(cfg) {
    ...
    const remoteChanged = hasEtagPair
      ? meta.lastRemoteETag !== remote.etag
  ...
  async function doUpload(cfg) {
    ...
    await patchSettingsMeta({
      ...
      lastRemoteModified: putTs || (remoteMeta && remoteMeta.lastModified) || (data.exportedAt || now),
      lastRemoteETag: putETag || (remoteMeta && remoteMeta.etag) || '',
